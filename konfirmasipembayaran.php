            ...
            <div class="table-responsive">
				...
				<form id="formku" action="" method="post">
					<?php
						...
						$query1 = mysqli_query($koneksi, "SELECT MAX(id_transaksi), total_harga FROM transaksi WHERE id_usr ='$id'");
						$result1 = mysqli_fetch_array($query1);
						$id_transaksi = $result1['MAX(id_transaksi)'];
						
						$error_bank = $error_rek = "";
						$nama_bank = $rekening = $nama = $biaya = ""; 
						...
						if (isset($_POST["finish"])){
							...
							if ($valid_bank && $valid_rek){
								...
								$query = "INSERT INTO konfirmasi_pembayaran (id_transaksi, nama_pengirim, nama_bank, no_rekening, jumlah_transfer, tgl_transfer) VALUES ('$id_transaksi', '$nama','$nama_bank','$rekening','$biaya','$tgl_transfer')";
								
								$query1 = "UPDATE status_transaksi SET status='waiting for confirmation' WHERE id_transaksi='$id_transaksi'";
